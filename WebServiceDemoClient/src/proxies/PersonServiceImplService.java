 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://examples.com/", wsdlLocation = "file:/E:/myperson.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://examples.com/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/E:/myperson.wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://examples.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://examples.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
